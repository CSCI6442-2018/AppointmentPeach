            ...
            <div class="row">
                    ...
                    <div class="card hoverable">
                        ...
                        <div class="card-content">
                            <div class="collection">
                                <a href="#!" class="collection-item red-text"><span class="new badge red"><?php get_num_status("pending");?></span>Pending</a>
                                <a href="#!" class="collection-item green-text"><span class="badge green-text"><?php get_num_status("approved");?></span>Approved</a>
                                <a href="#!" class="collection-item green-text text-darken-2"><span class="badge green-text text-darken-2 "><?php get_num_status("completed");?></span>Completed</a>
                                <a href="#!" class="collection-item grey-text"><span class="badge"><?php get_num_status("canceled");?></span>Canceled</a>
                            </div>
                            <!--End Collection -->
                        </div>
                ...
                <div class="col s5">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="collection">
                                <a href="#!" class="collection-item red-text"><span class="badge red-text" ><?php get_num_role("provider");?></span>Provider</a>
                                <a href="#!" class="collection-item green-text"><span class="badge green-text"><?php get_num_role("customer");?></span>Customer</a>
                            </div>
                        </div>
                        <div class="card-action">
                            <a href="#" class="red-text text-lighten-2">Go to detail</a>
