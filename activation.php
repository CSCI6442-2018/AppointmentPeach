...
function show_setup_menu()
{
    ...
    if (!$option_installed) {
        ...
        require_once "ap_overview_menu.php";

        require_once "ap_appointments_menu.php";

        require_once "ap_provider_menu.php";

        require_once "ap_test_menu.php";
    }
}
